...
def init_args():
    ...
    parser.add_argument("--customer_jj", default=False, type=bool, required=False,
                        help="The name of the task, selected from: [uabsa, aste, tasd, aope]")
    parser.add_argument("--dataset", default='rest14', type=str, required=False,
    ...
    parser.add_argument("--ckpoint_path", default='/opt/ml/model/cktepoch=1.ckpt', type=str,
                        required=False)
...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        dataloader = DataLoader(train_dataset, batch_size=self.hparams.train_batch_size, drop_last=True, shuffle=True,
                                num_workers=4)
        data_sample = train_dataset[2]  # a random data sample
