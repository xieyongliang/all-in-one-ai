...
def model_fn(model_dir):
    ...
    if(args.device == 'gpu'):
        os.system('pip install -U paddlepaddle-gpu -i https://pypi.tuna.tsinghua.edu.cn/simple')
        os.system('pip install -U onnxruntime-gpu -i https://pypi.tuna.tsinghua.edu.cn/simple')
        os.system('pip install nvgpu -i https://pypi.tuna.tsinghua.edu.cn/simple')
    else:
        os.system('pip install -U paddlepaddle-i https://pypi.tuna.tsinghua.edu.cn/simple')
        os.system('pip install -U onnxruntime -i https://pypi.tuna.tsinghua.edu.cn/simple')
