...
parser.add_argument("--train_file", default="/opt/ml/input/data/dataset/train.json", type=str)
parser.add_argument("--test_file", default="/opt/ml/input/data/dataset/test.json", type=str)
parser.add_argument("--validation_file", default="/opt/ml/input/data/dataset/val.json", type=str)
