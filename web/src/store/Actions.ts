export enum Action {
    ...
    UPDATE_PIPELINE_TRAINING_JOB_TRAINING_S3URI = '@@UPDATE_PIPELINE_TRAINING_JOB_TRAINING_S3URI',
    UPDATE_PIPELINE_TRAINING_JOB_VALIDATION_S3URI = '@@UPDATE_PIPELINE_TRAINING_JOB_VALIDATION_S3URI',
    UPDATE_PIPELINE_TRAINING_JOB_TEST_S3URI = '@@UPDATE_PIPELINE_TRAINING_JOB_TEST_S3URI',
