...
export const ALGORITHMS = [
    ...
    {label: 'Stable Diffusion Web UI', value: 'stable-diffusion-webui', reference: 'https://github.com/AUTOMATIC1111/stable-diffusion-webui/blob/master/README.md',  type: 'single', trainable: true, inferable: true, batchannotation: false},
    {label: 'Generic', value: 'generic', type: 'single', trainable: false, inferable: false, batchannotation: true},
    {label: 'Detr-resnet-101', value: 'detr', type: 'single', trainable: false, inferable: true, batchannotation: false},
