...
const CPTDemoForm: FunctionComponent<IProps> = (
    ...
    return (
        <Stack>
            ...
            {demoOption === 'sample' && <SampleTextForm input_format='text' output_format='text' header='Generative aspect based sentiment analysis' train_framework='pytorch' deploy_framework='pytorch'/>}
            {demoOption === 'local' && <LocalTextOutputTextForm header='Generative aspect based sentiment analysis' train_framework='pytorch' deploy_framework='pytorch'/>}
        </Stack>
    )
}
