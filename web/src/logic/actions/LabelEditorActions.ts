...
export class LabelEditorActions {
    ...
    public static swapSupportRenderingEngine(activeLabelType: LabelType) {
        LabelEditorActions.mountLabelSupportRenderingEngine(activeLabelType);
    };
    ...
    public static fullRender() {
        ...
        EditorModel.primaryRenderingEngine.render(LabelEditorActions.getEditorData());
        EditorModel.supportRenderingEngine && EditorModel.supportRenderingEngine.render(LabelEditorActions.getEditorData());
    }
